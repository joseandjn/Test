...
class CompanyListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        /*companyData = CompanyData(objectManagerContext: appDelegate.persistentContainer.viewContext)
        companyData?.delete()
        
        
        for item in 0...10000 {
            companyData?.save(company: CompanyModel(id: Int64(item), name: "Sedapal"))
        }*/
